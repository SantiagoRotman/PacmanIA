...
class CornersProblem(search.SearchProblem):
    ...
    A search state in this problem is a tuple ( pacmanPosition, foodGrid ) where
        ...
        corners: a tuple of the corners position and a bool to see if it has been explored 
    """
...
def cornersHeuristic(state, problem):
    ...
    for id, visited in enumerate(visits):
        if not visited:
            notVisitedcorners.append(corners[id])

    return pathCost(pos, notVisitedcorners)
